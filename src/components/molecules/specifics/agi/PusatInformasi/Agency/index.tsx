...
const Agency = (props: agencyProps) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex xs:flex-col lg:flex-row items-center gap-4 justify-between border border-gray_light rounded-xl p-4 ${tab.includes('Agency') && content ? 'mx-[2rem] lg:mx-[8.5rem] mb-[3.25rem]' : ''}`}
      >
