...
const Header = () => {
  ...
  return (
    <nav className="isolate sticky z-50 top-0">
      {/* White Section */}
      <div className="flex flex-row gap-2 justify-end items-center px-4 lg:px-16 py-4 text-gray_black bg-white">
      ...
      {/* Purple Section */}
      <div className="bg-gradient-to-b  from-purple_dark to-purple_light w-full m-0 text-white py-3 px-4 lg:px-8 relative">
