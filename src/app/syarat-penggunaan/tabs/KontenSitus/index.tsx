  ...
  return (
    <div>
      ...
      <p className="font-opensans font-normal text-tanya-avgen-detail-subtitle text-gray_body mt-[24px]">
        ...
        anak-anak perusahaan serta para afiliasinya (apabila ada) (secara
        bersama-sama juga disebut sebagai “Avrist”) tidak memberikan jaminan
        apapun, baik secara tersurat maupun tersirat, untuk setiap masalah
        apapun yang berkaitan dengan situs ini dan informasi, material, produk
        dan jasa yang terdapat didalamnya, termasuk namun tidak terbatas pada,
      ...
      <p className="font-opensans font-normal text-tanya-avgen-detail-subtitle text-gray_body mt-[24px]">
        ...
        web ini atau server yang menyediakannya bebas dari virus-virus atau
        komponen-komponen berbahaya lainnya, kode, agen, atau program yang
      ...
      <p className="font-opensans font-normal text-tanya-avgen-detail-subtitle text-gray_body mt-[24px]">
        ...
        tujuan informasi umum. Avrist tidak menjamin keakuratan, kecukupan atau
        kelengkapan informasi dan material dalam situs ini dan tidak bertanggung
        jawab atas kesalahan atau kelalaian dalam informasi dan material. Avrist
      ...
      <p className="font-opensans font-normal text-tanya-avgen-detail-subtitle text-gray_body mt-[24px]">
        ...
        situs-situs web tersebut tidaklah menyiratkan persetujuan atau
        pengesahan Avrist atas situs-situs tersebut atau isi di dalamnya.
      </p>
    </div>
  );
};

export default KontenSitus;
