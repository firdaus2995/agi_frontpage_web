...
const DetailBeritaAcara = ({ params }: { params: { detail: string } }) => {
  console.log(params);
  return (
    <>
      <Hero
        ...
        breadcrumbsData={[
          ...
          {
            title: 'Berita dan Acara',
            href: '/berita/berita?tab=Berita+dan+Acara'
          }
        ]}
      ...
      <div className="flex items-center justify-center w-full">
        <div className="flex flex-col gap-10 w-2/3 p-10">
          <div className="flex flex-col gap-5">
            <p className="text-purple_dark font-semibold">Berita dan Acara</p>
