      ...
      {slideItems.map((tab) => {
        ...
        return (
          <Button
            ...
            customButtonClass={`w-[95%] whitespace-nowrap p-2 border border-purple_dark rounded-lg text-center ${selected?.includes(activeTab) ? 'bg-purple_dark text-white' : 'text-purple_dark'} font-semibold`}
