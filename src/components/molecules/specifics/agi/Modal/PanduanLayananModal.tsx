                      ...
                      <div className="flex items-left flex-col">
                        <div className="my-[20px] flex flex-col gap-5">
                          ...
                          <p className="text-[18px]">
                            Mari selalu teliti sebelum membeli produk asuransi
                            jiwa dengan membaca isi proposal dengan baik dan
                            pertimbangkan dengan cermat segala manfaat dan
                            konsekuensinya.
                          </p>
                          <p className="text-[18px] font-bold ">
                            Ini dia hal-hal yang perlu Anda lakukan sebelum
