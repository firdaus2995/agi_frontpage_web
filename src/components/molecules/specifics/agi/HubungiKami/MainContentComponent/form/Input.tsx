        ...
        <Listbox value={selected} onChange={setSelected}>
          <div className="relative mt-1">
            ...
            <Transition
              ...
              leaveTo="opacity-0"
            >
              <Listbox.Options className="absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none lg:text-sm">
                {data.map((i, index) => (
                  <Listbox.Option
                    key={index}
                    className={({ active }) =>
