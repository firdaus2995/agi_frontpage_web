...
import ICON1 from '@/assets/images/agi/component/layanan-nasabah/icon-1.svg';
import ICON2 from '@/assets/images/agi/component/layanan-nasabah/icon-2.svg';
...
const data = [
  {
    icon: ICON1,
    title: 'Tanya Avgen',
    link1: 'Manfaat Asuransi Kendaraan',
    link2: 'Jenis Asuransi Kendaraan',
    link3: 'Lihat FAQs Lainnya',
    linkIcon: CHEVRONRIGHTPURPLE
  },
  {
    icon: ICON2,
    title: 'Hubungi Kami',
    link1: 'Pengaduan Nasabah',
    link2: 'Karir',
    link3: 'Tentang AvGen',
    linkIcon: CHEVRONRIGHTPURPLE
  }
...
const LayananNasabah = () => {
  ...
  const renderCard = (val: {
    ...
    <div
      className={`w-full h-[40vh] flex mb-10 md:flex-row xs:flex-col rounded-xl bg-white border items-center justify-center text-center shadow-xl border-b-8 border-b-purple_dark`}
    >
      ...
      >
        <p className="md:text-3xl xs:text-xl text-center w-full">
          {val.title}
        </p>
    ...
    <div className="flex flex-col self-stretch items-center justify-center py-32 gap-16 bg-white rounded-t-[65px] relative">
      ...
      <div>
        ...
        <p className="md:text-4xl xs:text-2xl text-gray_black_dark text-center px-10">
          Kami <span className="font-bold">Melayani</span> Dengan
          <span className="font-bold">Senang Hati!</span>
        </p>
      </div>
