...
import BannerImg1 from '@/assets/images/agi/sample-banner-1.svg';
import BannerImg2 from '@/assets/images/agi/sample-banner-2.svg';
import BannerImg3 from '@/assets/images/agi/sample-banner-3.svg';
    ...
    <div className="flex w-full overflow-x-hidden">
      <div className="w-full">
            ...
            {bannerData.map((data, index) => (
              ...
              >
                ...
                <div className="flex flex-col md:w-[40%] md:p-20 xs:p-10 gap-4 absolute z-50 top-10">
                  <p
                    className={`xs:text-[20px] md:text-[28px] text-agi_grey whitespace-nowrap xs:mt-10 md:mt-0`}
                  >
                    {data.category}
                  </p>
                  {data.title}
        ...
        <div className="w-full -mt-[6px] flex md:flex-row xs:flex-col">
          <div className="flex p-10 items-center justify-center text-white md:text-[28px] xs:text-[20px] text-left md:w-1/3 xs:w-full bg-agi_grey">
            <p>
